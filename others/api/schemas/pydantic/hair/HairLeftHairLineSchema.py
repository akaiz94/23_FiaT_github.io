...
class HairLeftHairLinePostRequestSchema(BaseModel):
...
class HairLeftHairLineSchema(HairLeftHairLinePostRequestSchema):
    idx: int


class HairLeftHairLineResponseSchema(HairLeftHairLineSchema):
    idx: Optional[int]
