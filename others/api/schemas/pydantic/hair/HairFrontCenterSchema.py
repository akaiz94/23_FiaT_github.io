...
class HairFrontCenterPostRequestSchema(BaseModel):
...
class HairFrontCenterSchema(HairFrontCenterPostRequestSchema):
    idx: int


class HairFrontCenterResponseSchema(HairFrontCenterSchema):
    idx: Optional[int]
