...
class HairFrontHairLinePostRequestSchema(BaseModel):
...
class HairFrontHairLineSchema(HairFrontHairLinePostRequestSchema):
    idx: int


class HairFrontHairLineResponseSchema(HairFrontHairLineSchema):
    idx: Optional[int]
