...
class AgreeClinicPPostRequestSchema(BaseModel):
    ...
    duty_page_yn: Optional[str] = None  # 미사용


class AgreeClinicPSchema(AgreeClinicPPostRequestSchema):
    visitkey: int


class AgreeClinicPResponseSchema(AgreeClinicPSchema):
