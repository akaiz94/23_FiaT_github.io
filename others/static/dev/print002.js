var ResultSkinConcenr_API_URL = 'http://localhost:8000/v1/skin/concern/';
var SkinResult_API_URL = 'http://localhost:8000/v1/skin/result/';
...
$(document).ready(function () {
    ...
    const customSex = localStorage.getItem('custom_sex');
    if (customSex === 'M') {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            console.log ("response[0].skin_gomin : ", response[0].skin_gomin);
            $('#skinGomin-1').append(response[0].skin_gomin);     
            // $('#skinGomin-2').append(response[0].skin_gomin);     
