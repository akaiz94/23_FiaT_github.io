...
$(document).ready(function () {
    ...
    * */
    ...
    var hairMain_URL = 'http://127.0.0.1:8000/v1/hairMain/' + '?surveyNo=' + surveyNo + '&userkey=' + userkey;
    $.ajax({
        url: hairMain_URL,
        type: 'GET',
        success: function (response) {
    ...
    var hairLeftHairLine_URL = 'http://127.0.0.1:8000/v1/hairLeftHairLine/' + '?surveyNo=' + surveyNo + '&userkey=' + userkey;
    var hairFrontCenter_URL = 'http://127.0.0.1:8000/v1/hairFrontCenter/' + '?surveyNo=' + surveyNo + '&userkey=' + userkey;
    var hairFrontHairLine_URL = 'http://127.0.0.1:8000/v1/hairFrontHairLine/' + '?surveyNo=' + surveyNo + '&userkey=' + userkey;
    var hairCenter_URL = 'http://127.0.0.1:8000/v1/hairCenter/' + '?surveyNo=' + surveyNo + '&userkey=' + userkey;
    var hairRightHairLine_URL = 'http://127.0.0.1:8000/v1/hairRightHairLine/' + '?surveyNo=' + surveyNo + '&userkey=' + userkey;
    var hairBack_URL = 'http://127.0.0.1:8000/v1/hairBack/' + '?surveyNo=' + surveyNo + '&userkey=' + userkey;
...
$(document).ready(function () {
    ...
    $('#submit-button').click(function () {
        ...
        // #2 Detailed Information On hair Thickness & Density 부분 API 값요청
        var hairLeftHairLine_URL = 'http://127.0.0.1:8000/v1/hairLeftHairLine/' + surveyNo;
