var API_URL = 'http://127.0.0.1:8000/v1/sch/visit/merged/list';
...
$(document).ready(function () {
    ...
    var customName = localStorage.getItem('custom_name');

    $('#manager_name').text(managerName);
    $('.user_name').text(customName);
...
function openMsgLayer(name, phone, birthdate, sex, m_userkey, m_surveyno) {
    ...
    console.log('userkey : ', m_userkey);
    console.log('surveyNo : ', m_surveyno);
    ...
    localStorage.setItem('custom_userkey', m_userkey);
    localStorage.setItem('custom_surveyNo', m_surveyno);
