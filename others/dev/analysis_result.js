  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      $.ajax({
        ...
        url: ResultVapometer_API_URL + 1966,
        type: 'GET',
        success: function (data) {
          vapometer = data;
          ...
          $.ajax({
            // url: ResultVapometer_API_URL + surveyNo,
            url: ResultCutometer_API_URL + 1956,
            type: 'GET',
            success: function (data) {
              cutometer = data;
...
$(document).ready(function () {
  ...
  $('#submit-button').click(function () {
    // #1st. Scalp Type, Hair Conditions, hair Density Type 부분 API 값요청     
    $.ajax({
      url: ResultMarkvu_API_URL + surveyNo,
      type: 'GET',
      success: function (data) {
...
function setSkinScore(markvu, vapometer, cutometer, skinsurvey, course_flg) {
  ...
  let selected_subdata = sorted_skin_data[0][0];
  let selected_subdata2 = sorted_skin_data[1][0];
